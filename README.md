...
- `staticcathedral_editor_tests`: custom editor contract, no generic editor, accessible named/tooltipped controls for every parameter, grayscale procedural motif.
