...
- `staticcathedral_editor_tests`: custom editor contract, no generic editor, accessible named/tooltipped controls for every parameter, minimal monochrome header-only paint with no decoration below y=80.
