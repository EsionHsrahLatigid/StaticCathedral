...
StaticCathedral is a bounded JUCE reverb implementation built from published feedback-delay-network and artificial-reverberation sources.
...
- Local JUCE plugin repositories under the EsionHsrahLatigid organization: source for EHL identity, CMake/JUCE shape, independent DSP tests, plugin integration tests, and artifact staging.
...
- StaticCathedral DSP design -> fixed prime delay lengths, high-density metallic texture, deterministic modulation, bounded freeze, and hard finite bounds.
